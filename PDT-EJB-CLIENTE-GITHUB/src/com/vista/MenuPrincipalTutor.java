...
public class MenuPrincipalTutor extends JFrame {

	private JPanel contentPane;
	private JDesktopPane menuTutor;
	...
	public MenuPrincipalTutor() {
		...
		menuTutor = new JDesktopPane();
		menuTutor.setBackground(new Color(44, 153, 171));
		menuTutor.setBorder(null);
		getContentPane().add(menuTutor, BorderLayout.CENTER);
		menuTutor.setLayout(null);
	}

	public void CentrarVentanaInterna(JInternalFrame internalFrame) {
		int x = (menuTutor.getWidth() / 2) - internalFrame.getWidth() / 2;
		int y = (menuTutor.getHeight() / 2) - internalFrame.getHeight() / 2;

		if (internalFrame.isShowing()) {
			internalFrame.setLocation(x, y);

		} else {
			menuTutor.add(internalFrame);
			internalFrame.setLocation(x, y);
